...
Ciezarowka:
	gcc Ciezarowka.c Funkcje/FunkcjeKolejkiKomunikatow.c Funkcje/FunkcjePamieciDzielonej.c Funkcje/FunkcjeSemafory.c -o Ciezarowka
...
P1:
	gcc P1.c Funkcje/FunkcjeKolejkiKomunikatow.c Funkcje/FunkcjePamieciDzielonej.c Funkcje/FunkcjeSemafory.c -o P1

P2:
	gcc P2.c Funkcje/FunkcjeKolejkiKomunikatow.c Funkcje/FunkcjePamieciDzielonej.c Funkcje/FunkcjeSemafory.c -o P2

P3:
	gcc P3.c Funkcje/FunkcjeKolejkiKomunikatow.c Funkcje/FunkcjePamieciDzielonej.c Funkcje/FunkcjeSemafory.c -o P3
